...
const sendVerificationEmail = async (to, name, code) => {
  await resend.emails.send({
    from: 'HNU Marketplace <onboarding@resend.dev>',
    to,
    ...
    html: `
      ...
      <head>
        <meta charset="UTF-8"/>
        <style>
          body { font-family: 'Segoe UI', sans-serif; background: #f0faf4; margin: 0; padding: 0; }
          ...
          .header { background: linear-gradient(135deg, #00ab41, #007d30); padding: 36px 40px; text-align: center; }
          ...
          .code-box { background: #f0faf4; border: 2px dashed #00ab41; border-radius: 12px; padding: 24px; text-align: center; margin: 24px 0; }
          .code { font-size: 48px; font-weight: 800; color: #00ab41; letter-spacing: 12px; font-family: monospace; }
          .expires { font-size: 13px; color: #999; text-align: center; margin-top: 0; }
          .footer { background: #f0faf4; padding: 20px 40px; text-align: center; font-size: 12px; color: #aaa; }
        </style>
      </head>
      <body>
        <div class="container">
    ...
    html: `
      ...
      <head>
        ...
        <style>
          ...
          .body { padding: 36px 40px; }
          .body p { color: #444; line-height: 1.6; font-size: 15px; margin: 0 0 16px; }
          .btn { display: block; width: fit-content; margin: 28px auto; background: #00ab41; color: white; text-decoration: none; padding: 14px 36px; border-radius: 10px; font-weight: 700; font-size: 15px; }
